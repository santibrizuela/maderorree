        ...
        <div className='w-full h-full'>
            ...
            >
                ...
                <div className='absolute top-[18%] lg:top-[24%] max-w-[1240px] w-full text-white z-20 p-2'>
                    ...
                    <h2 className='font-bold text-[2rem] text-red-500'>¿Qué hacemos?</h2>
            ...
            <motion.div
                ...
                <div className='col-span-4'>
                    <h2 className='text-[1.5rem] text-red-500'>Diseño Web-Alojamiento-DNS</h2>
                    <p>
                    ...
                    hacer <a href='/marketing' className='font-bold text-red-500'>Email Marketing</a> con promociones sobre tu marca.
